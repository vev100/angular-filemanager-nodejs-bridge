...
routes.post('/createFolder', upload.any(), function (req, res, next) {
  ...
  var folderPath = path.join(pathResolver.baseDir(req), req.body.newPath);
...
routes.post('/rename', function (req, res, next) {
  ...
  var oldPath = path.join(pathResolver.baseDir(req), req.body.item);
  var newPath = path.join(pathResolver.baseDir(req), req.body.newItemPath);
